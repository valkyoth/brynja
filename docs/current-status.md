...
Status: v0.20.0 published; milestones through v0.24.43 signed. The v0.24.44 candidate adds distinct default-off [hardened MD5 batch SIMD](legacy-md5-hardened-execution.md), clearing packed storage, affine batches, typed secret outputs and static/hosted selection. Exceptional retest, fresh native evidence and final release verification remain required; the prior cleanup finding is not yet declared closed. The signed v0.24.43 baseline is 4640d7c7. No crates.io publication, independent verification or FIPS validation is claimed.
