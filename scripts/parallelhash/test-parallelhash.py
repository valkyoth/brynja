...
def main() -> int:
    ...
    reject("executor-bound", Path("crates/brynja-hash-parallel-std/src/lib.rs"), "try_reserve_exact", "reserve_exact")
    reject("executor-cleanup", Path("crates/brynja-hash-parallel-std/src/lib.rs"), "clear_owned_region(leaf)", "core::hint::black_box(leaf)")
    ...
    print("ParallelHash policy rejects fifteen domain, encoding, lifecycle, cleanup, scheduling, evidence, test, and dependency regressions")
    return 0
