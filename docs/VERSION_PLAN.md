...
| `0.78.0` | Exporters And Channel Binding | Implement exporters and channel binding exactly once with context separation, transcript binding, authorization timing, and secret-output policy. |
