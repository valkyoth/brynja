//! Default-off hosted hardened SHA-512 family batching.
//!
...
//!
//! ```
//! use brynja_crypto_cpu_std::sha512_hardened_batch::{Authority, Error, Mode};
...
//! # Ok(()) }
//! ```
use brynja_crypto_cpu::sha512_hardened_batch::Authority as CpuAuthority;
/// Leaf operation failures, separate from hosted selection failures.
pub use brynja_hash_sha2::hardened_batch512::Error as ExecutionError;
...
///
/// ```compile_fail
/// use brynja_crypto_cpu_std::sha512_hardened_batch::Authority;
/// fn require<T: Send>() {}
/// require::<Authority>();
/// ```
///
...
///
/// ```compile_fail
/// use brynja_crypto_cpu_std::sha512_hardened_batch::{Authority, Executor, Mode};
...
fn backend(error: brynja_crypto_cpu::sha512_hardened_batch::Error) -> Error {
