...
1.98.1 exposes neither stable vector-crypto intrinsics nor stable vector-crypto
...
Both Rust 1.90.0 and 1.98.1 recognize `zknh`, compile the module, and emit all
