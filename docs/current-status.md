...
Status: v0.20.0 published; milestones through v0.24.25 signed; v0.24.26 ordinary/hardened general SHA-512/t hashing has a green owner retest and awaits release handoff, green GitHub/CodeQL and explicit tag permission. See the [candidate report](../security/pentest/v0.24.26.md). No CPU backend is admitted.
