...
| Normative requirements | 165 stable identifiers bind exact source, section, status, errata, authority role, strength, applicability, decision, mapping scope, owner, lifecycle, revision, assurance invariants, work bound, residual risk, target, positive and negative tests, and evidence gap; the generated closure covers all 126 authorities, 205 roadmap rows, and 4,422 surfaces, including 49 residual requirements, 33 residual authorities, 182 reviewed residual normative sections, 165 mapped sections, 17 explicit exclusions, and 742 formerly uncovered surfaces; immutable history and 108 requirement fixtures plus three surface-security fixtures reject omissions, orphaned cross-bundle delegations, semantic RFC 6066 laundering, non-reciprocal or boundary-mixed surface groups, wrong protocol ownership, actionable source-blocked legacy requirements, blanket section inheritance, drift, role errors, stale revisions, illegal transitions, unrelated mappings, weak bounds, missing anchors, rights gaps, stale mutable guidance, orphaned plans, repository-escaping targets, and premature claims |
