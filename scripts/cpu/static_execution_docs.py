...
def validate(root):
    ...
    words += ['fifty-eight', 'fifty-nine', 'sixty', 'sixty-one', 'sixty-two', 'sixty-three', 'sixty-four', 'sixty-five', 'sixty-six', 'sixty-seven']
...
def regressions(root):
    ...
    cases += [
        (DOCS[0], 'Status: sixty-seven exact', 'Status: nine exact'),
        (DOCS[0], 'Rust in only sixty-seven exact', 'Rust in only nine exact'),
