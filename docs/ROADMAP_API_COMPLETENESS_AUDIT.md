...
| A late protocol integration could conceal an unfinished standalone direction | v0.491.1 whole-project public-operation closure before integrated release rehearsal |
...
| Final product | v0.491.1 checks the complete public operation inventory, followed by integrated rehearsal, external audit, remediation and exact-candidate gates. |
