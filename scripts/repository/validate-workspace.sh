...
while IFS= read -r source; do
    if [[ "$source" == "crates/brynja-crypto-cpu-std/src/lib.rs" || \
          ...
          "$source" == "crates/brynja-legacy-sha1-std/src/lib.rs" ||
          "$source" == "crates/brynja-legacy-md5-std/src/lib.rs" ]]; then
...
expected = {
    ...
    "checksum": "0c395c5164295d69016c014a3c2dd69d28a84b7e89ba971c1e81b17acc41e411",
}
