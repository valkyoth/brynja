...
its owner retest and [native functional collection](assurance/sha3-execution-observations/v0.24.35/README.md) passed; the final gate remains pending. Further family integration remains planned.
