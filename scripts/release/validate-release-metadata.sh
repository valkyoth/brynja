...
grep -q 'scripts/constant-time/check-constant-time-codegen.sh 1.98.1 x86_64-unknown-linux-gnu' scripts/checks.sh
...
test -s security/dependency-admissions/sanitization-2.1.0.toml
...
grep -q 'scripts/zeroization/check-zeroization-codegen.sh 1.98.1 x86_64-unknown-linux-gnu' scripts/checks.sh
grep -q 'scripts/sanitization/check-sanitization-adapter-codegen.sh 1.98.1 x86_64-unknown-linux-gnu' scripts/checks.sh
