...
SCOPED_ROWS = {
    ...
    Path("crates/brynja-hash-sha2/README.md"): "| SHA-2 (all six identities have complete byte and arbitrary-bit APIs; hardened secret-bearing profiles pending) | 🚧 In progress | ❌ Not verified |",
