...
Status: v0.3.0 pentest remediation complete; awaiting independent retest
...
declarations are rejected before parsing. Release readiness remains blocked
until the tester confirms a clean retest.
