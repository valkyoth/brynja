...
| --- | --- | --- | --- |
| `brynja` | `0.23.2` | no | Internal facade milestone; v0.20.0 is published |
...
| `brynja-hash-sha2` | `0.1.0` | no | Unpublished complete portable six-algorithm FIPS 180-4 SHA-2 APIs; CPU candidates remain unadmitted |
