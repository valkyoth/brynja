...
| Single accelerated Keccak | `crates/brynja-crypto-cpu/src/hardened_execution/keccak.rs`, `crates/brynja-hash-sha3/src/hardened/accelerated/engine.rs` | Session copies, absorption, padding and squeeze can reintroduce values after a clean kernel return. |
