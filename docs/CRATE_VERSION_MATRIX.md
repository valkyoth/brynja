...
Status: v0.20.0 published; milestones through v0.24.34 signed. v0.24.35 adds default-off [ordinary SHA-3/SHAKE execution](sha3-ordinary-execution.md); owner retest passed, while native AArch64 collection and the final gate remain pending. Hardened SHA-2 execution is retained. No publication is selected.
