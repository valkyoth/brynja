...
`brynja-legacy-tls10` is an explicitly legacy and insecure TLS 1.0
...
only and does not implement TLS 1.0.

## Cryptography Verification Status

No TLS 1.0 code in this crate has been independently reviewed. This component
...
verification. Independent verification would not make TLS 1.0 secure.

| Component | Protocol scope | Independently verified |
| --- | --- | --- |
| `brynja-legacy-tls10` | TLS 1.0 controlled-interoperability engine | ❌ Not verified |
