...
def validate(root):
    ...
    words += ['fifty-eight', 'fifty-nine', 'sixty', 'sixty-one', 'sixty-two', 'sixty-three', 'sixty-four', 'sixty-five', 'sixty-six']
...
def regressions(root):
    ...
    cases += [
        (DOCS[0], 'Status: sixty-six exact', 'Status: nine exact'),
        (DOCS[0], 'Rust in only sixty-six exact', 'Rust in only nine exact'),
