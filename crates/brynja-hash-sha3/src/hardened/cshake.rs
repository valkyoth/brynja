    ...
    ($state:ident, $reader:ident, $rate:literal, $label:literal) => {
        ...
        impl $reader {
            ...
            pub fn squeeze_final_bits_public(
                ...
                self.squeeze_final_bits_public_erasing_source(output, authority)
            }
            ...
            pub fn squeeze_final_bits_secret<'output>(
                ...
                self.squeeze_final_bits_secret_erasing_source(output)
            }

            /// Produces one final public bit string and clears the exact
            /// embedded reader allocation before returning.
            #[doc(hidden)]
            ...
            /// Produces one final typed-secret bit string and clears the exact
            /// embedded reader allocation before returning.
            #[doc(hidden)]
            ...
            /// Clears this embedded reader in place.
            #[doc(hidden)]
            pub fn wipe_in_place(&mut self) {
                self.lifecycle = CshakeLifecycle::Vacated;
                self.owner.wipe();
