...
`brynja-legacy` is a narrowly scoped Brynja workspace package. In `0.1.0` it
...
No legacy protocol code in this crate has been independently reviewed. This
...
verification. Independent verification would not make an obsolete protocol
secure or suitable for new deployments.

| Component | Protocol scope | Independently verified |
| --- | --- | --- |
| `brynja-legacy` | Opt-in obsolete-protocol facade and isolation boundary | ❌ Not verified |
