...
The implemented portion currently consists of complete portable SHA-224 and
publicly accepted portable SHA-256; the shared alert/failure,
...
No cryptographic primitive other than portable SHA-224 and SHA-256, schema-driven ASN.1
