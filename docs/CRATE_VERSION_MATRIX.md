...
Status: v0.20.0 published; milestones through v0.24.34 signed. v0.24.35 adds default-off [ordinary SHA-3/SHAKE execution](sha3-ordinary-execution.md); owner retest, native Mac/AWS functional collection and required local release checks passed. Awaiting green GitHub/CodeQL. Hardened SHA-2 execution is retained. No publication is selected.
