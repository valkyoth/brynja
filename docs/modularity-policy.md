...
`brynja-fips-module`. The admission first established at v0.11.1 now permits
exact first-party `sanitization 2.1.0` only for this boundary; v0.11.2 introduced
the adapter and v0.24.22 refreshes its exact pin
