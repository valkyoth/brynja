...
this opt-in public-data surface; its exceptional retest and [native collection](assurance/cshake-execution-observations/v0.24.36/README.md) passed. Final release verification remains pending.
