...
this opt-in public-data surface; its exceptional retest, [native collection](assurance/cshake-execution-observations/v0.24.36/README.md) and full local release verification passed. Tagging awaits green GitHub and CodeQL.
