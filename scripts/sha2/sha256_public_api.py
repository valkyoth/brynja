...
CHECK_SCRIPT = Path("scripts/sha2/check-sha256-public-api.py")
TEST_SCRIPT = Path("scripts/sha2/test-sha256-public-api.py")
...
def validate_repository(root: Path = ROOT, check_hashes: bool = True) -> None:
    ...
    command = "python3 scripts/sha2/check-sha256-public-api.py"
