//! Default-off hosted hardened SHA-224/256 batching.
//!
...
//!
//! ```
//! use brynja_crypto_cpu_std::sha256_hardened_batch::{Authority, Error, Mode};
...
//! # Ok(()) }
//! ```
use brynja_crypto_cpu::sha256_hardened_batch::Authority as CpuAuthority;
/// Leaf operation failures, separate from hosted selection failures.
pub use brynja_hash_sha2::hardened_batch::Error as ExecutionError;
pub use brynja_hash_sha2::hardened_batch::{
    Algorithm, CAPACITY, Control, Executor, Input, Kernel, Mode, PublicDeclassification, Report,
    SecretBatchOutput, Workspace,
};
mod platform;
#[cfg(test)]
mod tests;
...
///
/// ```compile_fail
/// use brynja_crypto_cpu_std::sha256_hardened_batch::Authority;
/// fn require<T: Send>() {}
/// require::<Authority>();
/// ```
///
...
///
/// ```compile_fail
/// use brynja_crypto_cpu_std::sha256_hardened_batch::{Authority, Executor, Mode};
...
fn backend(error: brynja_crypto_cpu::sha256_hardened_batch::Error) -> Error {
