...
SCOPED_ROWS = {
    Path("crates/brynja-legacy-md5-std/README.md"): "| MD5 | In progress through v0.24.23 | ❌ Not independently verified |",
    ...
    Path("crates/brynja-legacy-sha1/README.md"): "| SHA-1 | 🚧 In progress — portable APIs implemented; final acceptance pending | ❌ Not independently verified |",
    Path("crates/brynja-legacy-md5/README.md"): "| MD5 | 🚧 In progress — portable APIs implemented; final acceptance pending | ❌ Not independently verified |",
