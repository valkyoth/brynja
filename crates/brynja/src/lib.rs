...
//! cSHAKE128/cSHAKE256 and all four hardened KMAC/KMACXOF byte/arbitrary-bit
//! APIs are also exposed through [`crypto`]. It exposes checked
...
//! algorithm outside these six SHA-2, six FIPS 202, two cSHAKE, and four KMAC
//! identities.
