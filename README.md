...
milestones continue through `0.24.27`; the current internal `0.24.28`
...
| --- | --- | --- |
| `brynja` | Modern production facade | Internal v0.24.28 keeps facade APIs unchanged; general SHA-512/t ordinary/hardened hashing is leaf-only, legacy leaves stay separate, CPU candidates remain unadmitted, and no TLS engine exists |
