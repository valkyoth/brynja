...
def main() -> int:
    ...
    reject("stream-batch-test-only", Path("crates/brynja-hash-parallel/src/execution/stream/batch.rs"), "#[cfg(test)]\nmod tests;", "mod tests;")
    reject("stream-batch-failure-test-only", Path("crates/brynja-hash-parallel/src/execution/stream/batch.rs"), "#[cfg(test)]\nmod failures;", "mod failures;")
