...
`brynja-legacy-snp` is an explicitly legacy and insecure SNP
...
only and does not implement SNP.

## Cryptography Verification Status

No SNP code in this crate has been independently reviewed. This component only
...
verification. Independent verification would not make SNP secure.

| Component | Protocol scope | Independently verified |
| --- | --- | --- |
| `brynja-legacy-snp` | SNP controlled-interoperability engine | ❌ Not verified |
