...
#[cfg(feature = "pct")]
pub use brynja_legacy_pct as pct;
#[cfg(feature = "snp")]
pub use brynja_legacy_snp as snp;
#[cfg(feature = "ssl2")]
pub use brynja_legacy_ssl2 as ssl2;
#[cfg(feature = "ssl3")]
pub use brynja_legacy_ssl3 as ssl3;
#[cfg(feature = "tls10")]
pub use brynja_legacy_tls10 as tls10;
#[cfg(feature = "tls11")]
pub use brynja_legacy_tls11 as tls11;
#[cfg(feature = "wtls")]
pub use brynja_legacy_wtls as wtls;
