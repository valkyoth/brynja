...
def validate(root):
    ...
    words += ['seventy', 'seventy-one', 'seventy-two', 'seventy-three', 'seventy-four']
...
def regressions(root):
    ...
    cases += [
        (DOCS[0], 'Status: seventy-four exact', 'Status: nine exact'),
        (DOCS[0], 'Rust in only seventy-four exact', 'Rust in only nine exact'),
