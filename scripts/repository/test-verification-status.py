...
def scoped_status_rows() -> None:
    ...
    counts = {
        ...
        "brynja-crypto-cpu-std": 8, "brynja-legacy-sha1-std": 1, "brynja-legacy-md5-std": 1,
    }
    mutations = 0
    ...
    assert sum(counts.values()) == 32 and mutations == 192
    print("Scoped/borrowed/protected status rows reject 192 omission, duplication, overclaim and stale-inventory regressions")
