...
| `crates/brynja-core/src/{numeric,quantity,sequence,budget}.rs`, `crates/brynja-core/tests/bounded_domains.rs` | v0.6.0 checked bounded integers, counts, lengths, sequences, epochs, and immutable resource/work budgets | Exhaustive small-domain operation matrices, zero/exact/overflow/underflow/exhaustion boundaries, pointer-width checks, no-mutation and representation tests, Clippy, `no_std`, and compile-fail doctests |
