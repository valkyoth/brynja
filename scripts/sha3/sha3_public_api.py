...
EXPECTED_SHA256: dict[Path, str] = {
    MANIFEST: "a9bfb11c28a5ee0fb9de5e33c6b3fc9d4dd4def62a5598145e7393de91a6a01a",
    LOCK: "5bd5b6d5ce2bcd1f85e886d1d4b65f793d2169390da2001552528139f3ab4bb0",
    ...
    LEAF_MANIFEST: "5049a02ff3a7fea3ed9d253bd9443c89808c0e44c8dc6f86d0449792be401da7",
    LEAF_LIB: "d2f5ebce2345775ae6f8a7b3a065adf26a117f9438ea2622cd52c352a99cc088",
    LEAF_README: "f092c93b4e738221d49124f71eee7da6f60d22ae0cf5c90d735b693cbee01232",
    CRYPTO_LIB: "bb425769dbf02a1c39a386196d013ab38f92f200f368f95d0911914f321f8785",
    FACADE_MANIFEST: "a158fa1cafa5ac81d3976225bd4819463d89e1b6374c8a7eaf359d90c972709c",
    FACADE_LIB: "dfa6311a5a73bed4547611739752052e8e98c30de7c8cd9536d1b0d0ebad8deb",
    FACADE_README: "aaa5a4282d03241ef9dd0a380daebcd56e003469123bb8c609570cdb3bb83ad0",
    ...
    CHECKS: "765bb78038b8f34cb27a866960ab7fc1d13c953dd34a230408b54628263e61af",
    RUST_MATRIX: "fec9a6ba60d2fdf016a5248760c332024085ecad2febfdeae5c8dd6ca7cc109f",
    BARE_METAL: "f2903e49017f442fc92bb6b85b2d709bb66c4274a8042dd065b59462d8dfed1a",
    WORKFLOW: "615b0d31f771498b236e69a80bfbf6a0bd131b2f6451962ae71ded2bf8692329",
}
PACKAGES = (
...
def validate_repository(root: Path = ROOT, check_hashes: bool = True) -> None:
    ...
    if leaf_manifest.get("features") != {
        ...
        "hardened-batch-execution": ["cpu", "brynja-crypto-cpu/keccak-hardened-batch"],
        ...
        fail("portable defaults or opt-in execution feature closure changed")
    if leaf_manifest.get("dependencies") != {
        "brynja-core": {"workspace": True}, "brynja-hash-core": {"workspace": True},
