...
Status: v0.20.0 published; milestones through v0.24.36 signed. The v0.24.37 hardened Keccak candidate implements opt-in erasing permutation scratch and SHA-3/SHAKE/cSHAKE absorbing/reader owners. Exceptional retest, fresh Intel/Linux Arm/Apple Arm native collection and required local release verification passed, including the selected Miri/ASan/Kani suites. Awaiting final GitHub/CodeQL approval before tagging. No publication, independent verification or FIPS validation is claimed.
