...
| `requirements/matrix.json` | Resolved pilot requirements bound to exact source, section, errata, registry, surface, and immutable parent-history evidence | Byte-for-byte regeneration and 49 positive/broken-fixture tests |
