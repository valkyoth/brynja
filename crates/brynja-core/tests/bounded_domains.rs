...
use brynja_core::{
    BoundedU64, BoundedUsize, Count, Epoch, ExhaustionPhase, Length, NumericError, ResourceBudget,
    ResourceDomain, ResourceKind, SequenceNumber, WorkBudget,
};
...
fn zero_budgets_admit_only_zero() {
    ...
    let domains = [
        ...
        ResourceDomain::WorkspaceBytes,
        ResourceDomain::StateItems,
        ResourceDomain::QueueItems,
        ResourceDomain::CertificateBytes,
        ResourceDomain::ProviderOperations,
    ];
