#!/usr/bin/env python3
"""Capture one native hardened TupleHash lane after a clean exceptional retest."""
import argparse
import json
import platform
...
def capture(lane, output):
    ...
    results = {'package': host.execute([sys.executable, 'scripts/tuplehash/check-tuplehash-execution.py', option], env)}
    ...
    with output.open('x', encoding='utf-8') as stream:
        ...
        stream.write('\n')
    print(f'Native hardened TupleHash capture: PASS; {lane}; commit={commit}')
