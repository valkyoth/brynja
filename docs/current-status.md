...
Status: v0.20.0 published; milestones through v0.24.34 signed. v0.24.35 adds [ordinary SHA-3/SHAKE execution](sha3-ordinary-execution.md) with explicit static/hosted routes. Focused implementation verification, the [owner-supplied retest](../security/pentest/v0.24.35.md) and [native Mac/AWS functional collection](../assurance/sha3-execution-observations/v0.24.35/README.md) passed. The final release gate remains pending. Hardened SHA-2 execution and its archived native observations remain unchanged. No publication, independent verification or FIPS validation is claimed.
