...
| Normative requirements | 163 stable identifiers bind exact source, section, status, errata, authority role, strength, applicability, decision, mapping scope, owner, lifecycle, revision, assurance invariants, work bound, residual risk, target, positive and negative tests, and evidence gap; the generated closure covers all 126 authorities, 205 roadmap rows, and 4,422 surfaces, including 47 residual requirements, 34 residual authorities, 193 reviewed residual normative sections, 175 mapped sections, 18 explicit exclusions, and 741 formerly uncovered surfaces; immutable history and 103 requirement fixtures reject omissions, non-reciprocal or boundary-mixed surface groups, blanket section inheritance, drift, role errors, stale revisions, illegal transitions, unrelated mappings, weak bounds, missing anchors, rights gaps, stale mutable guidance, orphaned plans, repository-escaping targets, and premature claims |
