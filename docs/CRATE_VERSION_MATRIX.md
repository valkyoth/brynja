...
modern package whose exact internal pin changes advances to `0.1.6`. `brynja-crypto` remains
unchanged at `0.1.0`.
...
| --- | --- | --- | --- |
| `brynja` | `0.10.0` | yes | Mandatory facade release exposing the v0.10 foundation domains |
| `brynja-core` | `0.7.0` | yes | Prior foundations plus abstract secret-lifetime and destruction-duty states |
| `brynja-crypto` | `0.1.0` | no | Published and unchanged |
| `brynja-pki`, `brynja-platform` | `0.1.6` | yes | Exact dependency pin changed; functionality remains a boundary |
| `brynja-tls`, `brynja-tls12`, `brynja-tls13`, and `brynja-tls13-handshake` | `0.1.6` | yes | Exact dependency pins changed; engines remain unimplemented |
| `brynja-dtls`, `brynja-quic-tls` | `0.1.6` | yes | Exact dependency pins changed; engines/adapters remain unimplemented |
...
For `v0.10.0`, publication order is `brynja-core 0.7.0`, `brynja-pki 0.1.6`,
