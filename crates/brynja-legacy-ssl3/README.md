...
`brynja-legacy-ssl3` is an explicitly legacy and insecure SSL 3.0
...
No SSL 3.0 code in this crate has been independently reviewed. This component
...
verification. Independent verification would not make SSL 3.0 secure.

| Component | Protocol scope | Independently verified |
| --- | --- | --- |
| `brynja-legacy-ssl3` | SSL 3.0 controlled-interoperability engine | ❌ Not verified |
