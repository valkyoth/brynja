...
pub use brynja_legacy_sha1::PublicDeclassification;
...
impl core::fmt::Display for Error {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(match self {
            ...
            Self::MessageTooLong => "strict legacy SHA-1 message domain exceeded",
            Self::InvalidBits => "strict legacy SHA-1 tail is not canonical",
            Self::Cancelled => "strict legacy SHA-1 cancelled",
            Self::OutputLength => "strict legacy SHA-1 output length mismatch",
            Self::Invariant => "strict legacy SHA-1 internal invariant failed",
        })
    }
}
