...
Status: v0.20.0 published; milestones through v0.24.34 signed. v0.24.35 adds default-off [ordinary SHA-3/SHAKE execution](sha3-ordinary-execution.md); owner retest and native Mac/AWS functional collection passed, while the final gate remains pending. Hardened SHA-2 execution is retained. No publication is selected.
