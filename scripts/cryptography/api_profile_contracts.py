...
from api_profile_operations import OPERATION_CONTRACTS
...
REGISTERED_CALLER_MIR_HEADERS = {
    ...
    TUPLEHASH_DROP: [
        "fn core_state::<impl at crates/brynja-hash-tuple/src/core_state.rs:234:1: 234:24>::"
...
REVIEWED_SOURCE_PATHS = {
    ...
    "assurance/register-cleanup/secret-predicate/Cargo.toml",
    "assurance/register-cleanup/secret-predicate/Cargo.lock",
    "assurance/register-cleanup/secret-predicate/src/lib.rs",
    "assurance/register-cleanup/secret-predicate/src/tests.rs",
    ...
    "assurance/register-cleanup/secret-copy/src/tests.rs",
    ...
    "scripts/cryptography/api_profile_operations.py",
