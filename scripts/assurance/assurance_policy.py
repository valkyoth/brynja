...
def validate_mutation(mutation: dict) -> None:
    ...
    if (
        mutation["runner"] != "scripts/assurance/assurance_mutation.py"
...
def validate_differential(differential: dict) -> None:
    ...
    if (
        differential["runner"] != "scripts/assurance/assurance_differential.py"
...
def validate_workflow(workflow: str) -> None:
    ...
    command = (
        "run: cargo check --workspace --exclude brynja-strict --exclude brynja-crypto-cpu-std --exclude brynja-hash-parallel-std --exclude brynja-legacy-sha1-std --exclude brynja-legacy-md5-std "
    ...
    platform_command = "run: python scripts/assurance/test-assurance.py"
...
def validate_repository(policy: dict) -> None:
    ...
    for relative in (
        ...
        "scripts/assurance/assurance_io.py",
        "scripts/assurance/assurance_process.py",
        "scripts/assurance/assurance_process_tree.py",
        "scripts/assurance/check-bare-metal.sh",
        "scripts/assurance/check-assurance.py",
        "scripts/assurance/test-assurance.py",
        "scripts/assurance/check-kani.sh",
        "scripts/repository/check-unsafe-policy.py",
        "scripts/repository/test-unsafe-policy.py",
...
def build_evidence(policy: dict | None = None) -> dict:
    ...
    inputs = [
        ...
        ROOT / "scripts" / "assurance" / "assurance_mutation.py",
        ROOT / "scripts" / "assurance" / "assurance_differential.py",
        ROOT / "scripts" / "assurance" / "assurance_io.py",
...
def network_check(policy: dict, *, require_latest_nightly: bool = False) -> None:
