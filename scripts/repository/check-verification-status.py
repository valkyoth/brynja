...
COMPONENT_ROWS = (
    ...
    "| `brynja-hash-parallel-std` | Optional zero-dependency worker/leaf-budgeted native-thread executor with reusable worker-sized storage and fallible scoped launch over the portable leaf-job and ordered-collector API | ❌ Not independently verified; excluded from FIPS boundaries |",
